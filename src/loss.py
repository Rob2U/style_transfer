...
class LossCalculator():
    ...
    def _style_loss(self, x, y): # loss implementation from ulyanov et al.
        ...
        # normalize
        G_diff_square_norm = torch.div(G_diff_square, c * c * h * h * w * w) # b, c, c
        return torch.sum(G_diff_square_norm).div(b) # b, c, c -> 1 (div by b to get mean)
    ...
    def calculate_loss(self, alpha, beta, gamma, generated_image, style_image, original_image):
        ...
        style_loss_weights = [1, 1, 1, 1, 1]  # [1/5, 1/5, 1/5, 1/5, 1/5]
