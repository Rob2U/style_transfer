...
class LossCNN(nn.Module):
    def __init__(self, content_layers, style_layers, **kwargs):
        ...
        self.vgg16 = torchvision.models.vgg19(weights=torchvision.models.VGG19_Weights.IMAGENET1K_V1, progress=True).features.to(ACCELERATOR)
...
class LossCalculator():
    def __init__(self, **kwargs):
        ...
        self.content_layers = ['conv_4'] # may try conv_3
        self.style_layers = ['conv_1', 'conv_2', 'conv_3', 'conv_4', 'conv_5'] # prev. relu_1, relu_2, relu_3, relu_4
    ...
    def _style_loss(self, x, y):
        ...
        return self.mse(gram_y, gram_x).div(b) # b, c, c -> 1

    def _feature_loss(self, x, y):
        b, c, h, w = x.shape
        return self.mse(x, y).div(b * c * h * w) # b, c, h, w -> 1
