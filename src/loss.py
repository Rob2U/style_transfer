...
class LossCalculator():
    def __init__(self, **kwargs):
        ...
        self.content_layers = ['relu_10'] # use conv4_2
        self.style_layers = ['relu_1', 'relu_3', 'relu_5', 'relu_9', 'relu_13'] # conv1_1, conv2_1, conv3_1, conv4_1, conv5_1
    ...
    def calculate_loss(self, alpha, beta, gamma, generated_image, style_image, original_image):
        ...
        style_loss_weights = [1/5, 1/5, 1/5, 1/5, 1/5]
